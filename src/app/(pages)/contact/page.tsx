              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@webfortuners.com</p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="aspect-video w-full bg-neutral-200 rounded-lg">
            <div className="w-full h-full flex items-center justify-center">
              <p className="text-neutral-500 text-lg">Google Map would be embedded here</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Thank you for contacting Web Fortuners. Our team will review your message and get back to you as soon as possible.
            </DialogDescription>
          </DialogHeader>
